...
SendableChooser *Scripting::generateAutonomousModes(char *scriptLocations) {
	...
	chooser->AddDefault("One Ball", new ScriptCommand(Autonomous::createAutoBall(1, 0)));
	chooser->AddObject("One Ball, Drive Back", new ScriptCommand(Autonomous::createAutoBall(1, -10)));
	chooser->AddObject("Two Ball", new ScriptCommand(Autonomous::createAutoBall(2, 0)));
	chooser->AddObject("Two Ball, Drive Back", new ScriptCommand(Autonomous::createAutoBall(2, -10)));
	chooser->AddObject("Three Ball", new ScriptCommand(Autonomous::createAutoBall(3, 0)));
	chooser->AddObject("Just Drive", new ScriptCommand(Autonomous::createJustDrive(0)));
	chooser->AddObject("Drive, Drive Back", new ScriptCommand(Autonomous::createJustDrive(-10)));
